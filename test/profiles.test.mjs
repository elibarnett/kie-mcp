...
const NON_TOOL_SNAKE = new Set(['prompt_extend', 'image_urls', 'video_urls', 'mask_indexs', 'image_edit', 'text_to_image', 'model_options', 'aspect_ratio', 'first_frame_url', 'last_frame_url']);
